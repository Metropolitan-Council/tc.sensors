...
```
![](../man/figures/calculate_speed_delay-unnamed-chunk-7-1.png)  
...
```
![](../man/figures/calculate_speed_delay-unnamed-chunk-9-1.png)
...
ggplot() +
  ...
  theme_minimal()
```
![](../man/figures/calculate_speed_delay-unnamed-chunk-12-1.png)
...
ggplot() +
  ...
  theme_minimal()
```
![](../man/figures/calculate_speed_delay-unnamed-chunk-13-1.png)
## Distance  
...
ggplot() +
  ...
  theme_minimal()
```
![](../man/figures/calculate_speed_delay-unnamed-chunk-17-1.png)  
