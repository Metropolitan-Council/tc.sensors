...
- [iris](https://github.com/mnit-rtmc/iris) MNIT/MnDOT repo for intelligent roadway information system (IRIS).
- [Mayfly API reference](https://data.dot.state.mn.us/mayfly/) The API through which MnDOT pushes loop detector data.

## Contributors  

**Maintainer** Liz Roten (liz.roten@metc.state.mn.us)  

[&#x0040;ashleyasmus](https://github.com/ashleyasmus), [&#x0040;eroten](https://github.com/eroten), [&#x0040;SeanZhangMC](https://github.com/SeanZhangMC),  and [&#x0040;sullivannicole](https://github.com/sullivannicole). 
