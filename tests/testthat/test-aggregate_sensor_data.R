...
testthat::try_again(2, {
  test_that("Aggregation functions as expected", {
    ...
    agg <- aggregate_sensor_data(sensor_results, interval_length = 0.25,
    ...
    agg_hour <- aggregate_sensor_data(sensor_results, interval_length = 1,
                                      config = config_sample)
    ...
    agg_day <- aggregate_sensor_data(sensor_results, interval_length = 24,
                                     config = config_sample)
